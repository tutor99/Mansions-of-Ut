...
public class PickUpScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerCamScript = player.GetComponent<PlayerCam>();
    ...
    void RotateObject()
    {
        ...
        {
            canDrop = false; // asegúrate de que no se pueda soltar mientras se rota
        ...
        {
            // Restablece el movimiento de la cámara cuando no se está rotando un objeto
